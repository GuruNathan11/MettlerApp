...
import {getAllergyByPatient} from '../../../redux/apiCalls';
...
const Allergy = ({route}) => {
  ...
  const allergyData = useSelector(state => state.user.allergyData);
          ...
          <FlatList
            ...
            renderItem={({item, index}) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  // setAId(item.id);
                  navigation.navigate('AllergyDetails', {item});
                }}>
                <View style={styles.patientView}>
                  <View style={styles.nameView}>
                    <Text style={styles.patientName}>
                      {item.causativeAgentName}
                    </Text>
                    <Text style={styles.patientUname}>{item.allergyType}</Text>
                  </View>
                  <View
                    style={[
                      styles.orgView,
